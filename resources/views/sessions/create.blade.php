      ...
      <fieldset>
        <div class="join-input">
          ...
          <div class="join-email br-bt">
            ...
            <input type="text" class="name" name="eamil-id" value="">
          ...
          <div class="join-pwd br-bt">
            ...
            <input type="password" class="pwd" name="pwd1" value="" placeholder="영문과 숫자조합 6~12자리">
          </div>
          <div class="join-pwd-chk br-bt">
            <div class="txt">
              비밀번호 확인
            </div>
            <input type="password" class="pwd-chk" name="pwd2" value="">
          </div>
          <div class="join-profile br-bt">
            <div class="txt">
              프로필 아이콘
